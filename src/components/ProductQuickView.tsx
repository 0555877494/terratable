...
export default function ProductQuickView({ product, onClose }: ProductQuickViewProps) {
  ...
  const variants = [
    ...
    { id: 'medium', name: 'Medium', price: product.price * 1.2 },
    { id: 'large', name: 'Large', price: product.price * 1.5 }
  ];
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-stone-800 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative">
              <img
                src={product.image}
                alt={product.name}
                className="w-full h-96 md:h-full object-cover md:rounded-l-3xl"
              />
